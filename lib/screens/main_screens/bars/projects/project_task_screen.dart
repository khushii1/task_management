                ...
                Row(
                  ...
                  children: [
                   Row(
                         ...
                         child: Column(
                           ...
                           children: [
                             Row(
                               ...
                               children: [
                                 10.widthBox,
                                 tableIcon.svg(colors: controller.choose==0?Colors.black:Colors.grey),
                                 5.widthBox,
                                 TextWidget(text: "Table",fontWeight: FontWeight.bold,color: controller.choose==0?Colors.black:Colors.grey,)
                               ],
                             ).onTap((){
                         ...
                         child: Column(
                           ...
                           children: [
                             Row(
                               children: [
                                 10.widthBox,
                                 ganttIcon.svg(colors: controller.choose==1?Colors.black:Colors.grey),
                                 5.widthBox,
                                 TextWidget(text: "Gantt",fontWeight: FontWeight.bold,color: controller.choose==1?Colors.black:Colors.grey)
                               ],
                             ).onTap((){
                         ...
                         child: Column(
                           ...
                           children: [
                             Row(
                               children: [
                                 10.widthBox,
                                 boardIcon.svg(colors: controller.choose==2?Colors.black:Colors.grey),
                                 5.widthBox,
                                 TextWidget(text: "Board",fontWeight: FontWeight.bold,color: controller.choose==2?Colors.black:Colors.grey)
                               ],
                             ).onTap((){
                    ...
                    Row(
                      children: [
                        TextWidget(text: "Progress:",color: Colors.grey,).pOnly(bottom: 5),
                        5.widthBox,
                        SizedBox(
                          width: 200,
                          child: ClipRRect(
