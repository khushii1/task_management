                        ...
                        children: [
                          ...
                          Pinput(
                            ...
                            defaultPinTheme: PinTheme(
                              ...
                              decoration: BoxDecoration(
                                border: Border(bottom: BorderSide(width: 0.5, color: Colors.black)), // add bottom border
                              ),
                            ),
                            focusedPinTheme: PinTheme(
                              ...
                              height: 20,
                              decoration: BoxDecoration(
                                border: Border(bottom: BorderSide(width: 0.5, color: Colors.black)), // change border color on focus
                              ),
                            ),
                            submittedPinTheme: PinTheme(
                              ...
                              height: 20,
                              decoration: BoxDecoration(
                                border: Border(bottom: BorderSide(width: 0.5, color: Colors.black)), // same as default
                              ),
                            ),
